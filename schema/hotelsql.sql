...
CREATE TABLE `checklist` (
  ...
  `guest_id` smallint(5) DEFAULT NULL COMMENT '入住客人编号',
  `guest_phone` varchar(30) DEFAULT NULL COMMENT '入住客人手机',
  `room_id` smallint(5) DEFAULT NULL COMMENT '入住房间编号',
...
CREATE TABLE `room` (
  `room_id` smallint(5) NOT NULL COMMENT '客房编号',
...
CREATE TABLE `room_review` (
  ...
  `review_room_id` smallint(5) DEFAULT NULL COMMENT '评论的房间编号',
